...
<execution_context>
@~/.claude/wsf/workflows/code-review.md
</execution_context>
...
Context files (CLAUDE.md, SUMMARY.md, phase state) are resolved inside the workflow via `wsf-tools init phase-op` and delegated to agent via `<files_to_read>` blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review workflow from @~/.claude/wsf/workflows/code-review.md end-to-end.
